  ...
  return {
    ...
    ai_config: {
      ...
      indicators: {
        ...
        ema_periods: form.enableEma ? (form.emaPeriods ?? []) : undefined,
        rsi_periods: form.enableRsi ? (form.rsiPeriods ?? []) : undefined,
        atr_periods: form.enableAtr ? (form.atrPeriods ?? []) : undefined,
        boll_periods: form.enableBoll ? (form.bollPeriods ?? []) : undefined,
